...
User LD1:
a green user LED is connected to the STM32 I/O PB0
(RCC_AHB1ENR = 2), (GPIOB_MODER = 01 pin0,1)

User LD2:
a blue user LED is connected to PB7. (GPIOB_MODER = 01 pin15,14)

User LD3:
a red user LED is connected to PB14. (GPIOB_MODER = 01 pin29,28)
